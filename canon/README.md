...
- A top **menu**: For you (home), Preferences, The 1,000 (`#archive` — the 1,000-work catalog), Collections, Recommendation log, About, and Terms of use. Phones use a hamburger icon
