...
Canon’s permanent public site is **https://hxyan2020.github.io/PRD/**. Deploy specs also live in `canon/vercel.json`, `canon/Dockerfile`, and `.do/app.yaml`. HX bots poll `canon/public/hx/health.json`; page views go to HX viewership as slug `canon`.
